...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_DB', 'lifemetrics'),
        'USER': os.getenv('POSTGRES_USER', 'lifemetrics_user'),
        'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'lifemetrics_password'),
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'lifemetrics.log',
